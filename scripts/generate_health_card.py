"""
Image 3: Health recommendations per member plus family tip.
"""
...
def generate():
    ...
    for member, tip in tips.items():
        ...
        text_color = MEMBER_TEXT.get(member, "#FFF")

        draw.rectangle([40, y, W - 40, y + 90], fill="#F8F8F8", outline=color, width=3)
        draw.rectangle([40, y, 180, y + 90], fill=color)
        draw.text((110, y + 45), member, font=font(18, True), fill=text_color, anchor="mm")
